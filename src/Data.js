const easy_words = [
    ...
    "onion", "carrot", "potato", "lettuce", "cucumber", "pepper", "garlic", "ginger", "honey",
    "syrup", "coffee", "tea", "sugar", "salt", "pepper", "cinnamon", "vanilla", "chocolate",
    "cream", "cake", "pie", "candy", "cookie", "brownie", "muffin", "pancake", "waffle", "toast",
    "sandwich", "hotdog", "bacon", "sausage", "egg", "toast", "jam", "jelly", "toast", "butter",
    "syrup", "cereal", "milk", "coffee", "juice", "water", "bread", "cheese", "tomato", "lettuce",
    "onion", "cucumber", "pepper", "salt", "pepper", "ketchup", "mustard", "mayonnaise", "ranch",
    "vinegar", "oil", "butter", "sugar", "flour", "yeast", "dough", "pasta", "rice", "potato",
